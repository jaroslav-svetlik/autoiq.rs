...
class TrendBlogPostSeederTest extends TestCase
{
    ...
    public function test_trend_blog_post_seeder_creates_idempotent_unique_article_catalog(): void
    {
        ...
        $this->assertTrue($posts->contains('slug', 'toyota-will-vs-ili-nissan-cube-cubic-neobicni-porodicni-auto-kada-prostor-mora-dokazati-stanje'));
        $this->assertTrue($posts->contains('slug', 'polovni-suzuki-kei-mali-auto-koji-mora-dokazati-turbo-limariju-i-delove'));
