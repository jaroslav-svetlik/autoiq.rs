...
- Added five non-duplicate production blog articles covering Mitsubishi Airtrek versus Toyota Kluger, used Toyota Platz and Nissan R'nessa buying guidance, panoramic-roof drain inspection, and Macau import due diligence.
...
- Added five non-duplicate production blog articles covering Toyota Sera versus Nissan 180SX, used Mazda Bongo Friendee and Suzuki Cappuccino buying guidance, bump-stop inspection, and Suriname import due diligence.

## [0.1.158] - 2026-09-13

### Added

- Added five non-duplicate production blog articles covering Toyota Cynos versus Mazda Familia Neo, used Honda Orthia and Nissan Rasheen buying guidance, brake-disc splash-shield inspection, and Malta import due diligence.
...
- Added five non-duplicate production blog articles covering Kia Cadenza versus Hyundai Azera, used Opel Sintra and Mitsubishi Space Wagon buying guidance, headrest-guide inspection, and commission-sale vehicle due diligence.
...
- Replaced narrative buyer, driver, owner, and seller phrasing across seeded article bodies and summaries with an impersonal professional automotive editorial style.
...
- Added five non-duplicate production blog articles covering Renault Kangoo versus Citroën Nemo, used Renault Symbol and SEAT Altea buying guidance, trunk-lock inspection, and North Macedonia import risk.
...
- Added five non-duplicate production blog articles covering Suzuki Kizashi vs Chevrolet Epica, used Mitsubishi Lancer and Mazda Premacy buying guidance, ISOFIX inspection, and Irish import risk.
...
- Publish the daily blog batch immediately instead of scheduling four articles into the future.
...
- Added five non-duplicate production blog articles covering Citroen C2 vs Ford Ka, used Toyota Urban Cruiser checks, used Honda FR-V buying guidance, rear-window defroster inspection, and Euro 5 diesel market risk.
...
- Added five non-duplicate production blog articles covering Nissan X-Trail checks, Honda Accord vs Toyota Avensis, replaced-engine risk, plug-in hybrid ownership, and used Fiat Tipo buying guidance.
...
- Reworded priority guide section copy on the homepage and blog index so it speaks to car buyers instead of exposing internal SEO language.
...
- Refined the Audi A4 B8 vs BMW 320d F30 deep-comparison article excerpt so the intro reads naturally without meta commentary.
